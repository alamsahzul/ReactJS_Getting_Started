...
class Home extends Component {
  render() {
    let heading = "Welcome to The Effective and Fun Learnig Method"
    let subheading = "Your success could be started from here"
        ...
        <section className="hero">
          <div className="hero-body">
              <div className="container">
                ...
                <div className="is-two-thirds colom is-paddingless">
                  <h2 className="subtitle is-4">{ subheading }</h2>
                </div>
                <a className="button is-large is-primary" id="learn">More Info</a>
              </div>
          </div>
        </section>
